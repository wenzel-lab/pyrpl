...
\
  ...
  connect_bd_net -net proc_sys_reset_0_interconnect_aresetn [get_bd_pins proc_sys_reset/interconnect_aresetn] [get_bd_pins axi_protocol_converter_0/aresetn]
  ...
  connect_bd_net -net processing_system7_0_fclk_clk0 [get_bd_pins processing_system7/FCLK_CLK0] [get_bd_ports FCLK_CLK0]
  connect_bd_net -net processing_system7_0_fclk_clk1 [get_bd_pins processing_system7/FCLK_CLK1] [get_bd_ports FCLK_CLK1]
  connect_bd_net -net processing_system7_0_fclk_clk2 [get_bd_pins processing_system7/FCLK_CLK2] [get_bd_ports FCLK_CLK2]
  connect_bd_net -net processing_system7_0_fclk_clk3 [get_bd_pins processing_system7/FCLK_CLK3] [get_bd_ports FCLK_CLK3] [get_bd_pins axi_protocol_converter_0/aclk] [get_bd_pins proc_sys_reset/slowest_sync_clk] [get_bd_pins processing_system7/M_AXI_GP1_ACLK] [get_bd_pins xadc/s_axi_aclk]
  connect_bd_net -net processing_system7_0_fclk_reset0_n [get_bd_pins processing_system7/FCLK_RESET0_N] [get_bd_ports FCLK_RESET0_N]
  connect_bd_net -net processing_system7_0_fclk_reset1_n [get_bd_pins processing_system7/FCLK_RESET1_N] [get_bd_ports FCLK_RESET1_N]
  connect_bd_net -net processing_system7_0_fclk_reset2_n [get_bd_pins processing_system7/FCLK_RESET2_N] [get_bd_ports FCLK_RESET2_N]
  connect_bd_net -net processing_system7_0_fclk_reset3_n [get_bd_pins processing_system7/FCLK_RESET3_N] [get_bd_ports FCLK_RESET3_N] [get_bd_pins proc_sys_reset/ext_reset_in]
  ...
  connect_bd_net -net xadc_wiz_0_ip2intc_irpt [get_bd_pins xadc/ip2intc_irpt] [get_bd_pins processing_system7/IRQ_F2P]
  connect_bd_net -net xlconstant_dout [get_bd_pins xlconstant/dout] [get_bd_pins proc_sys_reset/aux_reset_in]

  # Create address segments
  assign_bd_address -offset 0x40000000 -range 0x40000000 -with_name SEG_system_Reg -target_address_space [get_bd_addr_spaces processing_system7/Data] [get_bd_addr_segs M_AXI_GP0/Reg] -force
  assign_bd_address -offset 0x83C00000 -range 0x00010000 -with_name SEG_xadc_wiz_0_Reg -target_address_space [get_bd_addr_spaces processing_system7/Data] [get_bd_addr_segs xadc/s_axi_lite/Reg] -force
  assign_bd_address -offset 0x00000000 -range 0x20000000 -with_name SEG_processing_system7_0_HP0_DDR_LOWOCM -target_address_space [get_bd_addr_spaces S_AXI_HP0] [get_bd_addr_segs processing_system7/S_AXI_HP0/HP0_DDR_LOWOCM] -force
  assign_bd_address -offset 0x00000000 -range 0x20000000 -with_name SEG_processing_system7_0_HP1_DDR_LOWOCM -target_address_space [get_bd_addr_spaces S_AXI_HP1] [get_bd_addr_segs processing_system7/S_AXI_HP1/HP1_DDR_LOWOCM] -force
